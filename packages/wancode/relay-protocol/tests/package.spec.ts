...
describe('relay-protocol package surface', () => {
  ...
  it('keeps the loopback acceptor off the default protocol export', () => {
    ...
    expect(protocol).toHaveProperty('mintOutboundRelayPairingGrant')
    expect(protocol).toHaveProperty('redeemOutboundRelayPairingGrant')
    expect(protocol).toHaveProperty('createRelayPairingCode')

...
- `packages/wancode/` owns Wan Code protocol and cloud modules. `@wancode/relay-protocol` is the fail-closed remote-control contract and must not declare a loadable DSH plugin entry.

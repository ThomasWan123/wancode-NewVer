...
- Compatibility mode must run the upstream default client without layout, slot, or service overrides. The desktop Client may restyle upstream DeepSeek wordmarks and visible DeepSeek product copy to WanCodeNewVer in both modes. Advanced presentation belongs to desktop-owned client plugins and may replace documented slots or services through profile composition.

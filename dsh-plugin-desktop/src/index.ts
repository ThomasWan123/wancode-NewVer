/** Wancode Host plugin: owns the selected native shell generation. */
...
export function apply(ctx: Context, config: Config): void {
  ...
  if (runtime === undefined) {
    process.stderr.write(
      ...
      + 'Start it with `dsh-desktop`, or select this profile inside the packaged WanCodeNewVer application.\n'
  ...
  ctx.effect(
    () => runtime.schedule({
      ...
      productName: WANCODE_PRODUCT_NAME,
      windowTitle: WANCODE_WINDOW_TITLE,
      iconPath,
      trayIcons,
      readThemeSource: () => {
